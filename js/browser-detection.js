...
{'os': 'Any', 'browser': 'Firefox', 'version': 1},
{'os': 'Any', 'browser': 'Firefox', 'version': 2}, 
{'os': 'Any', 'browser': 'Firefox', 'version': 3}, 
{'os': 'Any', 'browser': 'Firefox', 'version': 4}, 
{'os': 'Any', 'browser': 'Firefox', 'version': 5}, 
{'os': 'Any', 'browser': 'Firefox', 'version': 6},
{'os': 'Any', 'browser': 'Safari', 'version': 4},
{'os': 'Any', 'browser': 'Opera', 'version': 8},
{'os': 'Any', 'browser': 'Chrome', 'version': 1},
{'os': 'Any', 'browser': 'Chrome', 'version': 2}, 
{'os': 'Any', 'browser': 'Chrome', 'version': 3}, 
{'os': 'Any', 'browser': 'Chrome', 'version': 4}, 
{'os': 'Any', 'browser': 'Chrome', 'version': 5}, 
{'os': 'Any', 'browser': 'Chrome', 'version': 6}, 
{'os': 'Any', 'browser': 'Chrome', 'version': 7}, 
{'os': 'Any', 'browser': 'Chrome', 'version': 8}, 
{'os': 'Any', 'browser': 'Chrome', 'version': 9},    
{'os': 'Any', 'browser': 'Chrome', 'version': 10}];
...
var BrowserDetection = {
	...
	noticeText: {
    	   ...
    	   'informal': {"title": "Nic z tego.",
		"notice": "Używasz przestarzałej przeglądarki. Nie tylko jesteś narażony na niebezpieczeństwo zainfekowania komputera, ale też pozbawiasz się wielu nowoczesnych funkcji. Najwyższy czas na zmianę!",
		"selectBrowser": "Jeśli chcesz, żeby strona działała poprawnie, kliknij w jeden z poniższych linków:",
		"remindMeLater": "Proszę o przypomnienie w późniejszym terminie",
		"neverRemindAgain": "Dajcie mi spokój"},
